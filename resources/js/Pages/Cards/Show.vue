...
<template>
    <Head>
        <title>Show Card Request</title>
    </Head>

    <div class="modal z-10 text-left">
        <h1 class="mb-6">Show Card Request</h1>
                ...
                <div class="py-2 inline-block mx-auto sm:px-6 lg:px-8 w-full">
                    <div class="overflow-hidden">
                        <table class="min-w-full rounded-2xl">
                            ...
                            <tr class="border-b border-t rounded-2xl">
                                <th class="w-1/5 bg-gray-200 text-sm font-medium text-gray-900 px-6 py-4 text-left"
                                    scope="col">
                                    #
                                </th>
                                <td
                                    class="bg-white px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 text-right"
                            ...
                            <tr class="border-b">
                                ...
                                <td
                                    class="bg-white px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 text-right"
                                    v-text="credit_card_request.formattedDate.formattedBirthDate"
                                ></td>
                            </tr>
                            <tr class="border-b">
                                <th class="w-1/5 bg-gray-200 text-sm font-medium text-gray-900 px-6 py-4 text-left"
                                ...
                                <td
                                    class="flex justify-end bg-white px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 text-right "
                                >
                            ...
                            <tr class="border-b">
                                ...
                                <td
                                    class="flex justify-end bg-white px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 text-right underline"
                                >
                                    <img :src="`/storage/${credit_card_request.selfie_passport}`"
                                         alt="" class="mr-auto rounded-full w-10 h-10 bg-cover object-center">
                                </td>
                            </tr>
                            <tr class="border-b">
                                <th class="w-1/5 bg-gray-200 text-sm font-medium text-gray-900 px-6 py-4 text-left "
...
.modal {
    @apply fixed bg-white px-4 py-6 rounded-xl z-20;
    top: 50%;
    left: 50%;
